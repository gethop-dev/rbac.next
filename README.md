[![Build Status](https://github.com/gethop-dev/rbac.next/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/gethop-dev/rbac.next/actions/workflows/ci-cd.yml)
